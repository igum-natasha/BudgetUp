...
public class ViewPagerAdapter extends PagerAdapter {
  ...
  Context context;
  int images[] = {R.drawable.onboarding1, R.drawable.onboarding2, R.drawable.onboarding3};
  int titles[] = {
    R.string.title_onboarding1, R.string.title_onboarding2, R.string.title_onboarding3
  };

  int desc[] = {R.string.desc_onboarding1, R.string.desc_onboarding2, R.string.desc_onboarding3};
