...
public class RVAdapterCalendar extends RecyclerView.Adapter<RVAdapterCalendar.CalendarViewHolder> {
    ...
    public RVAdapterCalendar.CalendarViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.calendar_item, viewGroup, false);
        ...
        ViewHolder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                for(int item = 0; item < linearLayoutList.size(); item++){
                    linearLayoutList.get(item).setBackgroundColor(view.getResources().getColor(R.color.primary_100));
                ...
                linearLayoutList.get(i).setBackgroundColor(view.getResources().getColor(R.color.primary_400));
