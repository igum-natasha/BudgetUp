...
public class DataParser {
    ...
    private void updateDB(Map<Integer, List<String>> data, View view) throws ParseException {
        ...
        new_data.put("others", new String[]{"Переводы людям", "Снятие наличных", "Наличные", "Подписки", "Переводы", "Остальное"});
...
//                        expense.setCard(value);
                    ...
                    case "Категория":
                        ...
                        image = view.getResources().getIdentifier(value, "drawable", view.getContext().getPackageName());
