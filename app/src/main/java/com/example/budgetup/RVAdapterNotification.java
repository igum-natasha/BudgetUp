...
public class RVAdapterNotification extends RecyclerView.Adapter<RVAdapterNotification.NotificationViewHolder> {
...
public static class NotificationViewHolder extends RecyclerView.ViewHolder
    ...
    @Override
    public RVAdapterNotification.NotificationViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.notification_item, viewGroup, false);
        RVAdapterNotification.NotificationViewHolder notificationViewHolder = new RVAdapterNotification.NotificationViewHolder(v);
    ...
    public void onBindViewHolder(RVAdapterNotification.NotificationViewHolder ViewHolder, int i) {
        ViewHolder.notificationInfo.setText(notifications.get(i).getName() + ": " + notifications.get(i).getMessage());
        ...
        ViewHolder.status.setBackgroundResource(ViewHolder.itemView.getResources().getIdentifier(image, "drawable", ViewHolder.itemView.getContext().getPackageName()));
    }
